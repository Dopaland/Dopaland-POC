...
| 12 | `D0PA1_Client_SignOff_001.md` dates itself as 2026-09-18 in its header and status line | Its signature row is dated **2026-09-19**. The record carries two dates, and which is correct is for the signatory to state; **not resolved here** | Found 2026-09-25, in the same check as #11 | Not established, as #11 |
